...
syn keyword cssPseudoClassId contained root empty checked enabled disabled not target
syn match cssPseudoClassId contained "\<first\(-\(line\|letter\|child\|of-type\)\)\=\>"
syn match cssPseudoClassId contained "\<only\(-\(child\|of-type\)\)\=\>"

syn region cssPseudoClassMethod matchgroup=cssPseudoClassId start=":lang(" end=")" oneline
syn region cssPseudoClassMethod matchgroup=cssPseudoClassId start=":nth-child(" end=")" oneline
syn region cssPseudoClassMethod matchgroup=cssPseudoClassId start=":nth-last-child(" end=")" oneline
syn region cssPseudoClassMethod matchgroup=cssPseudoClassId start=":nth-of-type(" end=")" oneline
syn region cssPseudoClassMethod matchgroup=cssPseudoClassId start=":nth-last-of-type(" end=")" oneline

syn match cssPseudoClass2 "::[^ {]*" contains=cssPseudoClassId2,cssUnicodeEscape
syn keyword cssPseudoClassId2 contained selection
...
if version >= 508 || !exists("did_css_syn_inits")
  ...
  HiLink cssPseudoClassId2 PreProc
  HiLink cssPseudoClassMethod Constant
